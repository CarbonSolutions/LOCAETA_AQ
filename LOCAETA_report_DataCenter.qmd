---
title: "LOCAETA report: Current 2020 grid with 300 MW grid demand in selected GEA regions"
format:
  html:
...
# set run_name
run_list = ['current_2020_MISO_Central','current_2020_SPP_North','current_2020_PJM_East','current_2020_MISO_South','current_2020_CAISO','current_2020_NorthernGrid_West']
...
#| label: fig-gea-region
#| fig-cap: Map of GEA regions in CONUS

import matplotlib.pyplot as plt
import matplotlib.image as img


img_path ='/Users/yunhalee/Documents/LOCAETA/DataCenter_emissions/gea_mappings_and_shapefiles/GEA_map.png'
...
img_path = f"{benmap_value_output_path}/{run_name}/Monetized Health Benefits  (million $).png"
image = img.imread(img_path)
...
img_path = f"{benmap_value_output_path}/{run_name}/Monetized Health Benefits  (million $) only mortality.png"
image = img.imread(img_path)
