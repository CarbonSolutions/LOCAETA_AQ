---
title: "LOCAETA report: Data Center in Memphis, Tennessee"
format:
  html:
...
# set run_name
run_name = 'TN_DataCenter_NOx_2ppm'
run_list = ['TN_DataCenter_NOx_2ppm', 'TN_DataCenter_NOx_25ppm'] # ['LA_CCS', 'LA_CCS_noNH3']
...
We estimated changes in air pollutant emissions resulting from running fossil fuels-based generators in data center in Memphis, TN: exact location is at latitude = 35.0598925 and longitude = -90.1559922684821. Two scenarios are considered in this study: emissions with assuming NOx 2ppm and the same but with assuming NOx 25 ppm.  
...
emis_file = '/Users/yunhalee/Documents/LOCAETA/CS_emissions/Data center case emission table.csv'
emis = pd.read_csv(emis_file)
GT(emis)
