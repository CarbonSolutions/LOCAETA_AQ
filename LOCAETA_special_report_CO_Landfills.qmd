---
title: "LOCAETA report: CO Landfills scenarios"
format:
  html:
...
# set run_name
run_name = "CO_landfills_scenario1"
run_list = ["CO_landfills_scenario1", "CO_landfills_scenario2"] # ["current_2020","decarb95_2050"] # ,"highREcost_2050"] # ['TN_DataCenter_NOx_2ppm', 'TN_DataCenter_NOx_25ppm'] # ['LA_CCS', 'LA_CCS_noNH3']
...
# Introduction 
The primary objectives of this study are to assess the socioeconomic and air quality impacts of the landfill emission scenarios from CDPHE, which includes total 5 landfill facilities over CO.  

# Emission Changes by Key Pollutants


@fig-total-emissions-changes summarizes the total emissions change by pollutants at each landfill facility (EIS_ID), resulting from the two landfill emission scenarios from CDPHE. 

```{python}

#| label: fig-total-emissions-changes
#| fig-cap: Change of air quality emissions at landfill facilities in CO
